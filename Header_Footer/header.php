                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            ?>
                                    <li class="scroll-to-section"><a href="../Booking/show_booking.php">Show Owders</a></li>
                                ...
                                ?>
                                    <li class="scroll-to-section"><a href="../Booking/show_booking.php">Show Oders</a></li>
                                    <li class="scroll-to-section"><a href="../Service/service.php">Services</a></li>
                                    <li>
                                        <div class="userDetails" id="UserDetails" style="cursor: pointer; background-color: beige;border: 2px solid black;height: 50px;width: 50px;border-radius: 50px;">
                                            <?php echo "<p style='margin-top: 1px; margin-left: 2px; font-size: 30px;'>" . substr($_SESSION['cName'], 0, 1) . "</p>"; ?>
                                ...
                                <?php
                                    // Incorrect OTP or error in logic
                                    // echo   $SESSION['OTP'] . "" . $_SESSION['user_input_otp'] . "<li class='scroll-to-section'><div class='error'>Error: OTP mismatch or not set properly.</div></li>";
                                }
                            } elseif (isset($_SESSION['cEmail_ID']) && isset($_SESSION['twoFactor']) && $_SESSION['twoFactor'] == 0) {
                                // Check if customer with 2FA disabled
                                ?>
                                <li class="scroll-to-section"><a href="../Booking/show_booking.php">Show Owders</a></li>
                                <li class="scroll-to-section"><a href="../Service/service.php">Services</a></li>
                                <li>
                                ...
                                <?php
                            } elseif (isset($_SESSION['eEmail_ID']) && isset($_SESSION['twoFactor']) && $_SESSION['twoFactor'] == 1) {
                            ...
                            } elseif (isset($_SESSION['eEmail_ID']) && isset($_SESSION['twoFactor']) && $_SESSION['twoFactor'] == 0) {
                                // Check if customer with 2FA disabled
                                ?>
                                <li class="scroll-to-section"><a href="../worker/show_accept_booking.php">Accepted Requests</a></li>
                                <li class="scroll-to-section"><a href="../worker/booking_request.php">Bookings Requested</a></li>
